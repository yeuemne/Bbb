...
function Library:app(params)
	...
	s = "Exponential",
	d = "Out",
	g = {TextTransparency = 0, TextColor3 = Color3.fromRGB(255, 100, 100)}}):Play()      
	Input_1.Active = false
	Header.Active = false        
	Library:Tween({
	v = Header,
	t = 0.3,
	s = "Exponential", 
	d = "Out",
	g = {BackgroundColor3 = Color3.fromRGB(80, 80, 85)}}):Play()    
    else
	LockText.Text = "Lock UI"
	Library:Tween({
	v = LockText,
	...
	s = "Exponential",
	d = "Out", 
	g = {TextTransparency = 0.5, TextColor3 = Color3.fromRGB(255, 255, 255)}}):Play()        
	Input_1.Active = true
	Header.Active = true       
	Library:Tween({
	v = Header,
	...
	s = "Exponential",
	d = "Out",
	g = {BackgroundColor3 = Color3.fromRGB(58,61,65)}}):Play()
    end
	end

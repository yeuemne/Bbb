...
function Library:app(params)
	...
	local BackgroundImageUrl = params.Background or nil
	local BackgroundTransparency = params.BackgroundTransparency or 0.15
	...
	MyButton.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
	MyButton.Size = UDim2.new(0, 40, 0, 40)
	MyButton.Draggable = true
	MyButton.Image = "http://www.roblox.com/asset/?id=100666805146072"
	local UICorner = Instance.new("UICorner")
	...
	if BackgroundImageUrl then
		...
		BackgroundImage.Image = Library:Asset(BackgroundImageUrl)
		BackgroundImage.ImageTransparency = BackgroundTransparency
		BackgroundImage.ScaleType = Enum.ScaleType.Crop
		BackgroundImage.ZIndex = -2		
		Blur_1.ImageTransparency = 0.8
	end
...
-- ========== ĐẶT CODE LOCK UI Ở ĐÂY ==========
-- THÊM NÚT LOCK DẠNG TRÒN CÓ CHỮ VÀO TOPBAR
local LockFrame = Instance.new("Frame")
local LockButton = Library:Button(LockFrame)
local ToggleCircle = Instance.new("Frame")
local LockText = Instance.new("TextLabel")

LockFrame.Name = "LockFrame"
LockFrame.Parent = Topbar_1
LockFrame.BackgroundColor3 = Color3.fromRGB(255,255,255)
LockFrame.BackgroundTransparency = 1
LockFrame.BorderColor3 = Color3.fromRGB(0,0,0)
LockFrame.BorderSizePixel = 0
LockFrame.LayoutOrder = 999999996
LockFrame.Size = UDim2.new(0, 45, 0, 25)

-- Vòng tròn nền
ToggleCircle.Name = "ToggleCircle"
ToggleCircle.Parent = LockFrame
ToggleCircle.AnchorPoint = Vector2.new(0.5, 0.5)
ToggleCircle.BackgroundColor3 = Color3.fromRGB(80, 80, 85)
ToggleCircle.BorderColor3 = Color3.fromRGB(0,0,0)
ToggleCircle.BorderSizePixel = 0
ToggleCircle.Position = UDim2.new(0.5, 0, 0.5, 0)
...
LockText.Parent = ToggleCircle
LockText.AnchorPoint = Vector2.new(0.5, 0.5)
LockText.BackgroundColor3 = Color3.fromRGB(255,255,255)
LockText.BackgroundTransparency = 1
LockText.BorderColor3 = Color3.fromRGB(0,0,0)
LockText.BorderSizePixel = 0
LockText.Position = UDim2.new(0.5, 0, 0.5, 0)
...
LockText.TextTransparency = 0.3
LockText.ZIndex = 3

-- BIẾN THEO DÕI TRẠNG THÁI LOCK
...
local function toggleLock()
    ...
    if isLocked then
        -- Đổi chữ thành "Unlock" và màu đỏ
        ...
        Library:Tween({
            ...
            s = "Exponential",
            d = "Out",
            g = {BackgroundColor3 = Color3.fromRGB(220, 80, 80)}
        }):Play()
        Library:Tween({
            v = LockText,
            t = 0.3,
            s = "Exponential",
            d = "Out",
            g = {TextTransparency = 0, TextColor3 = Color3.fromRGB(255, 255, 255)}
        }):Play()
        
        -- Thêm hiệu ứng visual để biết là đã lock
        Library:Tween({
            v = Header,
            t = 0.3,
            s = "Exponential", 
            d = "Out",
            g = {BackgroundColor3 = Color3.fromRGB(70, 70, 75)}
        }):Play()
        
    else
        -- Đổi chữ thành "Lock" và màu xám
        LockText.Text = "Lock"
        Library:Tween({
            v = ToggleCircle,
            t = 0.3,
            s = "Exponential",
            d = "Out",
            g = {BackgroundColor3 = Color3.fromRGB(80, 80, 85)}
        }):Play()
        Library:Tween({
            v = LockText,
            t = 0.3,
            s = "Exponential",
            d = "Out", 
            g = {TextTransparency = 0.3, TextColor3 = Color3.fromRGB(255, 255, 255)}
        }):Play()
        ...
        Library:Tween({
            ...
            s = "Exponential",
            d = "Out",
            g = {BackgroundColor3 = Color3.fromRGB(58,61,65)}
        }):Play()
    end
end
